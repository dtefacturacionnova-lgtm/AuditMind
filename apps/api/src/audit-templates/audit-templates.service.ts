    ...
    return [
      ...
      // ═══════════════════════════════════════════════════════════════════════
      {
        ...
        papers: [
          ...
          { code: 'B-PEPS-02', indexSection: 'B-PEPS',
            title:    'Revisión de Consulta a Listas de Sanciones OFAC / ONU / UK (GAFI Rec. 6)',
            type:     WorkingPaperType.SUBSTANTIVE_TEST, wpKind: WpKind.SMART,
            paperCode: 'PT-PLD' },
      ...
      // ═══════════════════════════════════════════════════════════════════════
      {
        ...
        sections: [
          { ref: 'APF', name: 'Archivo Permanente Fiscal',                 phaseType: 'PLANNING',
            children: [
              ...
              { ref: 'APF-10', name: 'Situación Legal y Societaria (Código de Comercio)' },
            ],
          },
          ...
          { ref: 'RET', name: 'Retenciones en la Fuente',                    phaseType: 'FIELDWORK',
            children: [
              { ref: 'RET-01', name: 'Retenciones sobre Dividendos y Utilidades (Art. 74-A LISR)' },
              { ref: 'RET-02', name: 'Retenciones a No Domiciliados (Art. 158 CT)' },
              { ref: 'RET-03', name: 'Retenciones a Paraísos Fiscales (Art. 158-A CT)' },
              { ref: 'RET-04', name: 'Conciliación Global de Retenciones — F-14 vs. Mayor' },
            ],
          },
          { ref: 'OF', name: 'Obligaciones Formales',                       phaseType: 'FIELDWORK',
            children: [
              ...
              { ref: 'OF-06', name: 'Informe Anual de Retenciones (F-910)' },
              { ref: 'OF-07', name: 'Informe de Clientes y Proveedores (F-987)' },
              { ref: 'OF-08', name: 'Informe de Accionistas y Utilidades (F-915)' },
              { ref: 'OF-09', name: 'Impuestos Municipales y Aportes Patronales (ISSS/AFP/INSAFORP)' },
            ],
          },
        ...
        papers: [
          ...
          { code: 'APF-10', indexSection: 'APF-10',
            title:    'Situación Legal y Societaria — Escritura, Matrícula y Libros (Código de Comercio Arts. 411, 435, 441)',
            type:     WorkingPaperType.PLANNING_UNDERSTANDING, wpKind: WpKind.SMART,
            paperCode: 'PT-B1' },
          ...
          { code: 'A-07', indexSection: 'A',
            ...
            type:   WorkingPaperType.PLANNING_UNDERSTANDING, wpKind: WpKind.STANDARD },
          { code: 'A-08', indexSection: 'A',
            title:    'Materialidad Fiscal — Base Global y por Tributo (NACOT §10)',
            type:     WorkingPaperType.PLANNING_UNDERSTANDING, wpKind: WpKind.SMART,
            paperCode: 'PT-FISC-MAT' },
          ...
          { code: 'IVA-07', indexSection: 'IVA-07',
            ...
            type:     WorkingPaperType.SUBSTANTIVE_TEST, wpKind: WpKind.SMART,
            paperCode: 'PT-FISC-CAAT-LIBROSIVA' },
          // ── RET — Retenciones en la Fuente (4 papeles) ───────────────────
          { code: 'RET-01', indexSection: 'RET-01',
            title:    'Retenciones sobre Dividendos y Utilidades Distribuidas — 5% (Art. 74-A LISR)',
            type:     WorkingPaperType.SUBSTANTIVE_TEST, wpKind: WpKind.SMART,
            paperCode: 'PT-B2' },
          { code: 'RET-02', indexSection: 'RET-02',
            title:    'Retenciones a Sujetos No Domiciliados — 20% (Art. 158 CT)',
            type:     WorkingPaperType.SUBSTANTIVE_TEST, wpKind: WpKind.SMART,
            paperCode: 'PT-B2' },
          { code: 'RET-03', indexSection: 'RET-03',
            title:    'Retenciones a Paraísos Fiscales / Baja o Nula Tributación — 25% (Art. 158-A CT)',
            type:     WorkingPaperType.SUBSTANTIVE_TEST, wpKind: WpKind.SMART,
            paperCode: 'PT-B2' },
          { code: 'RET-04', indexSection: 'RET-04',
            title:    'Conciliación Global de Retenciones — F-14 Acumulado vs. Mayor Contable',
            type:     WorkingPaperType.SUBSTANTIVE_TEST, wpKind: WpKind.SMART,
            paperCode: 'PT-B2' },
          // ── OF — Obligaciones Formales (9 papeles) ───────────────────────
          ...
          { code: 'OF-05', indexSection: 'OF-05',
            ...
            type:     WorkingPaperType.NORMATIVE_ANALYSIS, wpKind: WpKind.SMART,
            paperCode: 'PT-FISC-CAAT-PLAZOS' },
          { code: 'OF-06', indexSection: 'OF-06',
            title:    'Informe Anual de Retenciones (F-910) — Verificación de Presentación y Cifras',
            type:     WorkingPaperType.NORMATIVE_ANALYSIS, wpKind: WpKind.SMART,
            paperCode: 'PT-B1' },
          { code: 'OF-07', indexSection: 'OF-07',
            title:    'Informe de Clientes y Proveedores (F-987) — Verificación de Presentación y Cifras',
            type:     WorkingPaperType.NORMATIVE_ANALYSIS, wpKind: WpKind.SMART,
            paperCode: 'PT-B1' },
          { code: 'OF-08', indexSection: 'OF-08',
            title:    'Informe de Accionistas y Utilidades Distribuidas (F-915)',
            type:     WorkingPaperType.NORMATIVE_ANALYSIS, wpKind: WpKind.SMART,
            paperCode: 'PT-B1' },
          { code: 'OF-09', indexSection: 'OF-09',
            title:    'Impuestos Municipales y Aportes Patronales — ISSS / AFP / INSAFORP',
            type:     WorkingPaperType.SUBSTANTIVE_TEST, wpKind: WpKind.SMART,
            paperCode: 'PT-B2' },
          ...
          { code: 'D-08', indexSection: 'D',
            ...
            type:   WorkingPaperType.CLOSURE_CONCLUSION, wpKind: WpKind.STANDARD },
          { code: 'D-09', indexSection: 'D',
            title:    'Carta de Manifestaciones / Salvaguarda del Contribuyente (NACOT §15, PE21)',
            type:     WorkingPaperType.CLOSURE_CONCLUSION, wpKind: WpKind.SMART,
            paperCode: 'PT-FISC-REP' },
          { code: 'D-10', indexSection: 'D',
            title:    'Hoja de Supervisión y Cierre del Encargo — Checklist NACOT',
            type:     WorkingPaperType.CLOSURE_CONCLUSION, wpKind: WpKind.SMART,
            paperCode: 'PT-B1' },
        ],
        ...
        links: [
          ...
          { sourceCode: 'A-03', targetCode: 'A-05', sourceField: 'S7', targetField: 'S3', mappingType: 'AI_GENERATED', description: 'Riesgo por impuesto → Riesgo Inherente del Memo' },
          { sourceCode: 'A-08', targetCode: 'A-05', sourceField: 'S7', targetField: 'S4', mappingType: 'AI_GENERATED', description: 'Materialidad fiscal → Materialidad del Memo' },
          ...
          { sourceCode: 'A-03', targetCode: 'D-06', sourceField: 'S7', targetField: 'S3', mappingType: 'AI_GENERATED', description: 'Riesgo por impuesto → Riesgo Inherente del Informe' },
          { sourceCode: 'A-08', targetCode: 'D-06', sourceField: 'S7', targetField: 'S4', mappingType: 'AI_GENERATED', description: 'Materialidad fiscal → Materialidad del Informe' },
