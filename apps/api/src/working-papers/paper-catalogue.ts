...
export const PAPER_CATALOGUE: PaperCatalogueEntry[] = [
  ...
  { code: 'PT-FIN-C-NORM',   group: 'Auditoría Financiera — Pruebas y Cierre', wpKind: 'SMART',  type: 'NORMATIVE_ANALYSIS', title: 'Análisis Normativo por Área (genérico)',                           hint: 'NIA 550 Partes Rel. / NIA 570 Continuidad Operativa' },
...
const _EXT_FIN = [
  ...
  'PT-ADJ-RECLASIF', 'PT-DIFS', 'PT-CIRC', 'PT-FIN-C-SUST', 'PT-FIN-C-NORM',
