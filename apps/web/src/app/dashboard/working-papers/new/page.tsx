...
const CANONICAL_PAPER_GROUPS: { group: string; items: CanonicalPaper[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { code: 'PT-NIA250',    label: 'Evaluación del Cumplimiento de Leyes y Regulaciones NIA 250 (Revisada)', kind: 'SMART', type: 'PLANNING_UNDERSTANDING', hint: 'Marco legal SV, procedimientos 16 pasos, indagaciones dirección, asesor legal, matriz incumplimientos, riesgo, conclusión' },
