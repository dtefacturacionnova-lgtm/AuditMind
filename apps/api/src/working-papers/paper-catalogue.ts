...
export const PAPER_CATALOGUE: PaperCatalogueEntry[] = [
  ...
  { code: 'PT-FIN-C-NORM',   group: 'Auditoría Financiera — Pruebas y Cierre', wpKind: 'SMART',  type: 'NORMATIVE_ANALYSIS', title: 'Continuidad Operativa — Negocio en Marcha (NIA 570)',              hint: 'Indicadores financieros/operacionales, procedimientos, impacto en dictamen' },
...
const _EXT_FIN = [
  ...
  'PT-ADJ-RECLASIF', 'PT-DIFS', 'PT-CIRC', 'PT-FIN-C-SUST', 'PT-FIN-C-NORM', 'PT-NIA550',
